...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div className="md:hidden sticky top-0 z-40 bg-white/75 border-b border-gray-200/50 flex justify-center items-center h-14">
        <button 
      ...
      {/* Desktop Navbar */}
      <header className="hidden md:block sticky top-0 z-40 border-b border-gray-200/50 bg-white/75">
        <div className="mx-auto flex max-w-[1600px] items-center justify-between px-4 py-4 lg:px-12">
          ...
          <div className="relative flex items-center gap-4 text-gray-700">
            {/* Currency Toggle */}
            <div className="flex items-center bg-gray-100/80 p-0.5 rounded-full text-[11px] font-bold tracking-wider">
              <button
                type="button"
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/75 border-t border-gray-200/50 flex justify-around items-center h-16 shadow-t">
      ...
      {mobileMenuOpen && (
        ...
        >
          ...
          >
            ...
            {/* Mobile Footer Actions (Currency Switcher) */}
            <div className="p-4 border-t border-gray-100 bg-gray-50 space-y-2">
              <span className="text-[10px] uppercase font-bold tracking-widest text-gray-400 block">Currency</span>
